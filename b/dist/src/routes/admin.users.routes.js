...
const adminCtrl = __importStar(require("../controllers/adminUser.controller"));
const auth_middleware_1 = require("../middlewares/auth.middleware");
const isAdmin_middleware_1 = require("../middlewares/isAdmin.middleware");
const router = (0, express_1.Router)();
// GET /admin/users
router.get('/users', auth_middleware_1.authenticateAccessToken, isAdmin_middleware_1.isAdmin, adminCtrl.listUsers);
