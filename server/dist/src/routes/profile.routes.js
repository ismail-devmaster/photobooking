...
router.get('/me', auth_middleware_1.authenticateAccessToken, profileCtrl.getMyProfile);
router.put('/me', auth_middleware_1.authenticateAccessToken, profileCtrl.updateMyProfile);
